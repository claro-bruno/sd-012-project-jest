...
describe('verifica o usuário', () => {
  ...
  api.fetchURL = jest.fn()
    .mockImplementation(async () => fakeApi);
...
// Links
// Segui a recomendação do Igor Fernandes repo: https://github.com/tryber/sd-012-project-jest/blob/Igor-Fernandes-project-Jest/test/mockApi.spec.js
