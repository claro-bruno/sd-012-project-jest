...
describe('verifica o usuário', () => {
  ...
  api.fetchURL = jest.fn().mockImplementation(async () => testApi);
  // Usei como referência para o assincronismo a resposta do Ryan Laiber no slack: https://trybecourse.slack.com/archives/C01T2C18DSM/p1623955632184900
