...
/*  Referencias
Na documentação do jest - funções de simulação, localizada a mockResolvedValue(Value) (https://jestjs.io/pt-BR/docs/mock-function-api#mockfnmockresolvedvaluevalue);
Pequisei a implementação correta e encontrei nos comentarios da discução do github no link - https://github.com/facebook/jest/issues/6552 */
